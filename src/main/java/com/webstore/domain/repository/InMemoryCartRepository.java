...
import com.webstore.dto.CartItemDto;
...
public class InMemoryCartRepository implements CartRepository {
    ...
    @Autowired
    public InMemoryCartRepository(NamedParameterJdbcTemplate jdbcTemplate, ProductService productService) {
    ...
    public void update(String id, CartDto cartDto) {
        ...
        for (CartItemDto cartItem : cartItems) {
            String SQL = "UPDATE CART_ITEM " +
                    "SET QUANTITY= :quantity, PRODUCT_ID = :productId " +
